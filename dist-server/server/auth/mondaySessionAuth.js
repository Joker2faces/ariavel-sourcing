...
export class MondaySessionAuthError extends Error {
    constructor(msg) { super(msg); this.name = 'MondaySessionAuthError'; }
}
export function verifyBuyerSessionToken(rawToken, clientSecret) {
    let decoded;
    try {
        decoded = jwt.verify(rawToken, clientSecret);
    }
    catch {
...
export function verifyMondaySignedRequest(body, signature, signingSecret) {

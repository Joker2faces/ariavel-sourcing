...
const defaultSupplierService = createSupplierService(createInMemorySupplierRepository(mockSuppliers), developmentTenantContextProvider, mockMondayBoardProvider);
...
export default function App({ supplierService = defaultSupplierService }: { supplierService?: SupplierService }) {
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      {activeNav === 'Suppliers' ? <SuppliersPage service={supplierService} /> : <SourcingHub title={activeNav} />}
    </main>
  </div>;
}
